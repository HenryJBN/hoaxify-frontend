...
describe('UserSignupPage', ()=> {
    ...
    describe('Interactions', ()=>{
        ...
        it('calls postSignup when fields are valid and actions are provided in the props', ()=> {
            const actions = {
        ...
        it('does not throw exception when clicking the button when  actions are not provided in the props', ()=>{
        ...
        it('calls post with user body when fields are valid', ()=> {
            ...
            expect(actions.postSignup).toHaveBeenCalledWith(expectedUserBody);

        });

        it('does not allow users to click the signup button when there is an ongoing api call', ()=> {
            const actions = {
        ...
        it('shows a spinner when there is an ongoing api call', ()=> {
            const actions = {
                postSignup: mockAsyncDelayed()
            }
        ...
        it('displays validationn error for displayName when error is received for the field', async ()=>{
            const actions = {
        ...
        it('enables sign up button when password and repreat password fields have same value', ()=>{
        ...
        it('disables sign up button when repeat password doesnt match  with password ', ()=>{
        ...
        it('disables sign up button when password doesnt match  with repreat password ', ()=>{
        ...
        it('displays error style for password repeat input  when password  mismatch', ()=>{
